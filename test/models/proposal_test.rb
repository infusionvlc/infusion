...
class ProposalTest < ActiveSupport::TestCase
  ...
  test 'Invalid without user' do
  	...
  	assert_not_equal proposal.errors.count, 0, 'Proposal is valid without an User'
  ...
  test 'Invalid without title' do
  	...
  	assert_not_equal proposal.errors.count, 0, 'Proposal is valid without an Title'
  ...
  test 'Invalid without description' do
  	...
  	assert_not_equal proposal.errors.count, 0, 'Proposal is valid without an Description'
