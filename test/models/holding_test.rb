...
class HoldingTest < ActiveSupport::TestCase
	...
	meetup = Meetup.new(title: "TestMeetup1", description: "TestDescription", requirements: "TestRequirements", date: Date.today, confirmation_mail: false)
  	...
  	test 'Invalid without user' do
  		...
  		assert_not_equal holding.errors.count, 0, 'Holding is valid without an User'
  	...
  	test 'Invalid without meetup' do
  		...
  		assert_not_equal holding.errors.count, 0, 'Holding is valid without an Meetup'
  	...
  	test 'Invalid without role' do
  		...
  		assert_not_equal holding.errors.count, 0, 'Holding is valid without an Role'
