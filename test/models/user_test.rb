...
class UserTest < ActiveSupport::TestCase
    test 'Valid User' do 
      user = User.new(reset_password_token: 'TestPasswordToken',
                      ...
                      locale: 'es', avatar_file_name: 'TestName',
                      avatar_content_type: 'image', avatar_file_size: 10,
                      avatar_updated_at: DateTime.now, role_id: 1,
                      bio: 'TestBio')
    ...
    test 'Invalid without locale' do
       user = User.new(reset_password_token: 'TestPasswordToken',
                       ...
                       avatar_file_name: 'TestName',
                       avatar_content_type: 'image',
                       avatar_file_size: 10, avatar_updated_at: DateTime.now,
                       role_id: 1,
                       bio: 'TestBio')
